...
TRUNCATION_MODES = ['ont_r9', 'ont_spatial', 'pacbio', 'none']
TRUNCATION_DICT5 = {
    # pacbio sequel
...
def main():
    ...
    parser_t.add_argument('--truncation_mode', help='truncation mode: none, pacbio, ont_r9, ont_spatial', default='ont_r9')
