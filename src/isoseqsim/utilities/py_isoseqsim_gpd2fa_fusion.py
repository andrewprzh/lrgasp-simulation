...
def convert_gpd_to_fasta(input_fa_fl, input_gpd_fl, output_fa_fl):
    ...
    for line in input_gpd_fl:
        # parse first isoform
        gene1, iso1, chr1, strand1, tss1, tts1, cds_start1, cds_end1, exon_number1, exon_start1, exon_end1 = line.strip().split(
            "\t")[:11]
        seq_list1 = []
        ...
        for i in range(len(up_seq_list1)):
        ...
        gene2, iso2, chr2, strand2, tss2, tts2, cds_start2, cds_end2, exon_number2, exon_start2, exon_end2 = line.strip().split(
            "\t")[11:]
        seq_list2 = []
        ...
        for i in range(len(up_seq_list2)):
